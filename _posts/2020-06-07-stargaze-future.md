...
Extracted from <d-cite key="songchun_2017_qiantan"></d-cite>
...
1. The sense of survival can be perhaps implemented by telling the robot to "do something" to prevent its battery from going below 20% (point of discussion)
...
PS: The thumbnail is a scene from The Heroic Legend of Arslan 
